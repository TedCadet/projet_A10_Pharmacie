...
VALUES(1325969751,'Proulx','Michel','M','24062501',TO_DATE('24-06-1925','DD-MM-YYYY'),TO_DATE('05-03-2020','DD-MM-YYYY'),59630145);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(1635249856,'Bédard','Laurent','M','27097501',TO_DATE('27-09-1975','DD-MM-YYYY'),TO_DATE('15-03-2020','DD-MM-YYYY'),16482375);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(1965784256,'Blais','Sophia','F','09071601',TO_DATE('09-07-2016','DD-MM-YYYY'),TO_DATE('25-03-2020','DD-MM-YYYY'),60314967);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(2046589631,'Couture','Damien','M','29010101',TO_DATE('29-01-2001','DD-MM-YYYY'),TO_DATE('18-02-2020','DD-MM-YYYY'),34695210);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(2415963788,'Cyr','Yvette','F','20046901',TO_DATE('20-04-1969','DD-MM-YYYY'),TO_DATE('28-02-2020','DD-MM-YYYY'),86419562);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(2679854130,'Dion','Myriam','F','26129901',TO_DATE('26-12-1999','DD-MM-YYYY'),TO_DATE('14-01-2020','DD-MM-YYYY'),54723810);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(3652154789,'Mercier','Romuald','M','28025301',TO_DATE('28-02-1953','DD-MM-YYYY'),TO_DATE('25-01-2020','DD-MM-YYYY'),73269421);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(3125698541,'Bolduc','Alain','M','17073601',TO_DATE('17-07-1936','DD-MM-YYYY'),TO_DATE('22-01-2020','DD-MM-YYYY'),59630145);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(3025690185,'Fortier','Marie-Anne','F','22108301',TO_DATE('22-10-1983','DD-MM-YYYY'),TO_DATE('30-01-2020','DD-MM-YYYY'),29671548);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(4201569389,'Hamel','Claude','M','16040801',TO_DATE('16-04-2008','DD-MM-YYYY'),TO_DATE('08-04-2020','DD-MM-YYYY'),94526387);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(4632589610,'Germain','Sabrina','F','08108801',TO_DATE('08-10-1988','DD-MM-YYYY'),TO_DATE('18-04-2020','DD-MM-YYYY'),42103690);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(4698521307,'Lemay','Nicolas','M','05067401',TO_DATE('05-06-1974','DD-MM-YYYY'),TO_DATE('13-04-2020','DD-MM-YYYY'),16482375);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(5132964520,'Villeneuve','Sophie','F','18129001',TO_DATE('18-12-1990','DD-MM-YYYY'),TO_DATE('09-02-2020','DD-MM-YYYY'),86419562);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(5426978162,'Larouche','Claudette','F','21120401',TO_DATE('21-12-2004','DD-MM-YYYY'),TO_DATE('01-04-2020','DD-MM-YYYY'),54723810);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(6130254987,'Moreau','Jacques','M','30084501',TO_DATE('30-08-1945','DD-MM-YYYY'),TO_DATE('10-02-2020','DD-MM-YYYY'),73269421);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(6485936980,'Bertrand','Martine','F','24115501',TO_DATE('24-11-1955','DD-MM-YYYY'),TO_DATE('07-03-2020','DD-MM-YYYY'),34695210);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(7215489645,'Lacroix','Marjolaine','F','13099601',TO_DATE('13-09-1996','DD-MM-YYYY'),TO_DATE('14-02-2020','DD-MM-YYYY'),29671548);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(7398754610,'Gélinas','Martin','M','01077901',TO_DATE('01-07-1979','DD-MM-YYYY'),TO_DATE('22-01-2020','DD-MM-YYYY'),60314967);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(8462597568,'Pépin','Amélie','F','26048601',TO_DATE('26-04-1986','DD-MM-YYYY'),TO_DATE('24-04-2020','DD-MM-YYYY'),42103690);
INSERT INTO dossierpatient (numDos, nomP, prenomP, genre, numAS, dateNaiss, dateC, matricule)
VALUES(8634512059,'Giguère','Rodrigue','M','15106801',TO_DATE('15-10-1968','DD-MM-YYYY'),TO_DATE('03-05-2020','DD-MM-YYYY'),94526387);
